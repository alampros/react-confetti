...
| `confettiSource`     | `{ x: Number, y: Number, w: Number, h: Number } OR { pointA: {x: Number, y: Number}, pointB: {x: Number, y: Number}, pointC: {x: Number, y: Number}}` | `{x: 0, y: 0, w: canvas.width, h:0}`                                                                                                                                                                                                                                               | Rectangle or parallelogram where the confetti should spawn. Default is across the top. If a parallelogram, point B is assumed to have sides connecting to points A and C, with an inferred point D across from it. |
