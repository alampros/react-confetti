...
| `confettiSource`     | `{ x: Number, y: Number, w: Number, h: Number } OR EmitterShape` | `{x: 0, y: 0, w: canvas.width, h:0}`                                                                                                                                                                                                                                               | Shape where the confetti should spawn. Default is across the top. |
