	...
	var Confetti = function (_React$Component) {
	  ...
	  _createClass(Confetti, [{
	    ...
	    value: function componentDidMount() {
	      this.confetti = (0, _confetti2.default)(this.refs.confetti).numberOfPieces(this.props.numberOfPieces).friction(this.props.friction).wind(this.props.wind).gravity(this.props.gravity).colors(this.props.colors);
	    }
	  }, {
	    key: 'componentWillReceiveProps',
	    value: function componentWillReceiveProps(nextProps) {
	      this.confetti.numberOfPieces(nextProps.numberOfPieces).friction(nextProps.friction).wind(nextProps.wind).gravity(nextProps.gravity).colors(nextProps.colors);
	    }
	  }, {
	    key: 'render',
