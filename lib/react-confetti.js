  ...
  function self() {
    ...
    ParticleGenerator.prototype.animate = function animateParticle() {
      if (this.particlesGenerated < this.number) {
        var newParticleX = utils.randomRange(this.x, this.w + this.x);
        var newParticleY = utils.randomRange(this.y, this.h + this.y);
      ...
      for (var i = 0; i < this.particles.length; i++) {
        ...
        if (p.y > canvas.height || p.y < -100 || p.x > canvas.width + 100 || p.x < -100) {
          if (this.recycle) {
            ...
            var _newParticleX = utils.randomRange(this.x, this.w + this.x);
            var _newParticleY = utils.randomRange(this.y, this.h + this.y);
    ...
    var generator1 = new ParticleGenerator(confettiSource, numberOfPieces);
...
var Confetti = function (_React$PureComponent) {
  ...
  _createClass(Confetti, [{
    ...
    value: function componentDidMount() {
      this.confetti = (0, _confetti2.default)(this.canvas).numberOfPieces(this.props.numberOfPieces).confettiSource(this.props.confettiSource).friction(this.props.friction).wind(this.props.wind).gravity(this.props.gravity).colors(this.props.colors).opacity(this.props.opacity).recycle(this.props.recycle)();
    }
  }, {
    key: 'componentWillReceiveProps',
    value: function componentWillReceiveProps(nextProps) {
      this.confetti.numberOfPieces(nextProps.numberOfPieces).confettiSource(nextProps.confettiSource).friction(nextProps.friction).wind(nextProps.wind).gravity(nextProps.gravity).colors(nextProps.colors).opacity(nextProps.opacity).recycle(nextProps.recycle);
    }
  }, {
    key: 'render',
...
Confetti.propTypes = {
  ...
  confettiSource: _propTypes2.default.shape({
