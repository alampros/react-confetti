/*! react-confetti - 0.0.1 | (c) 2015, 2016  Aaron Lampros <alampros@gmail.com> | MIT | https://github.com/alampros/react-confetti#readme */
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _confetti = __webpack_require__(2);
	...
	var Confetti = function (_React$Component) {
	  ...
	  _createClass(Confetti, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement('canvas', { ref: 'confetti', style: canvasStyles });
	    }
	  }]);
	...
	function confetti(canvas) {
	  ...
	  particleGenerator.prototype.animate = function () {
	    ...
	    if (this.particles.length < this.number) {
	      this.particles.push(new particle(utils.clamp(utils.randomRange(this.x, this.w + this.x), this.x, this.w + this.x), utils.clamp(utils.randomRange(this.y, this.h + this.y), this.y, this.h + this.y), this.text));
	    }
	    ...
	    for (var i = 0; i < this.particles.length; i++) {
	      ...
	      if (p.y > H || p.y < -100 || p.x > W + 100 || p.x < -100 && this.recycle) {
	        ...
	        this.particles[i] = new particle(utils.clamp(utils.randomRange(this.x, this.w + this.x), this.x, this.w + this.x), utils.clamp(utils.randomRange(this.y, this.h + this.y), this.y, this.h + this.y), this.text);
	      }
	    }
	  };
	  toggleEngine();
